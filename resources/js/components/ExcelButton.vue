<template>
    <div class="col">
        <div @click="download"  class="row icon-excel">
            <div class="btn">
                <svg width="50" height="30" fill="#000060" viewBox="0 0 493.525 493.525" >
                    <g id="XMLID_30_">
            ...
            <div class="btn">Export messages</div>
        </div>
    </div>
</template>
        ...
        methods: {
            download() {
                axios({
                    ...
                    fileLink.setAttribute('download', 'messages.xlsx');
